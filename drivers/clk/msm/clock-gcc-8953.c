...
static struct clk_freq_tbl ftbl_gfx3d_clk_src[] = {
	...
	F_MM( 682000000,    1230000000,               gpll3,    1,    0,     0),
	F_MM( 739000000,    1290000000,               gpll3,    1,    0,     0),
        F_MM( 900000000,    1350000000,               gpll3,    1,    0,     0),
        F_MM( 1100000000,   1410000000,               gpll3,    1,    0,     0),
        F_MM( 1200000000,   1470000000,               gpll3,    1,    0,     0),
