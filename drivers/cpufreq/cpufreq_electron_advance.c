...
#include <trace/events/cpufreq_electron_advance.h>
bool state_suspended1;
/* Electron version */
...
static void cpufreq_electron_timer(unsigned long data)
{
	...
	tunables->boosted = (tunables->boost_val || now < tunables->boostpulse_endtime) && !state_suspended1;
